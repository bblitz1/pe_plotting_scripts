...
parser.add_argument('--num_sims', type=int, choices=[10, 30, 50, 100], required=True, help="Number of simulations to include.")
...
data_files = [f"simulation_{i}.json" for i in range(1, args.num_sims + 1)]
